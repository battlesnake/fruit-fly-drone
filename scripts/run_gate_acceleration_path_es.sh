...
search_cache_dir="/home/mark/tmp/fly-acceleration-path-es"
...
cd "$repo_root"
exec aira confine --memory-reserve 4G --memory-max 20G -- \
    .venv/bin/python scripts/search_gate_acceleration_path_es.py "$@"
