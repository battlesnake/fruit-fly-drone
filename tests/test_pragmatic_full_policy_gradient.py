...
def test_full_gradient_probe_uses_archived_data_and_restores_source(monkeypatch, tmp_path, fail):
    ...
    saved = torch.load(args.output_dir / "full-gradient-data.pt", weights_only=True)
